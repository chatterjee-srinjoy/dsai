...
# Rules are defined in 06_rules.yaml for easier maintenance and version control.

# Learn more about standard AI rules formatting here: https://aicodingrules.org/

# Load in rules
rules = yaml::read_yaml("06_agents/04_rules.yaml")
...
# =============================================================================
# Same workflow as 05_multiple_agents.R, but with rules incorporated
